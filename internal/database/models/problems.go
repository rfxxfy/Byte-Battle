...
func (problemL) LoadDuels(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProblem interface{}, mods queries.Applicator) error {
	var slice []*Problem
	var object *Problem
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (problemL) LoadSolutions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProblem interface{}, mods queries.Applicator) error {
	var slice []*Problem
	var object *Problem
