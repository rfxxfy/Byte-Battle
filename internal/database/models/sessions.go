...
var (
	sessionAllColumns            = []string{"id", "user_id", "token", "expires_at", "created_at", "updated_at"}
	sessionColumnsWithoutDefault = []string{"user_id", "token", "expires_at"}
	sessionColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
